    ...
    licenseName.appendChild(document.createTextNode('µTorrent Web Pro.'));
    ...
    let licenseBuyButton1 = document.createElement('a');
    licenseBuyButton1.setAttribute('class', 'upgrade-to-pro-button-2 buy-license-expiry-button');
    licenseBuyButton1.setAttribute('href', 'https://www.utorrent.com/webpro-offer/?utm_source=Lavasoft&utm_medium=version_1.0&utm_campaign=Scanner');
    licenseBuyButton1.setAttribute('target', '_blank');
    licenseBuyButton1.innerHTML = 'Buy Pro + VPN';
    ...
    licenseBuyButton2.setAttribute('href', 'https://www.utorrent.com/webpro-offer/?utm_source=Lavasoft&utm_medium=version_1.0&utm_campaign=Scanner');
    licenseBuyButton2.setAttribute('target', '_blank');
    licenseBuyButton2.innerHTML = 'Buy Pro';
    ...
    let licenseTitle4 = document.createElement('div');
    licenseTitle4.setAttribute('class', 'nav-se-title');
    licenseTitle4.innerHTML = "Pro User";
    ...
    licenseStep3.append(licenseIcon3, licenseTitle3, licenseText5, licenseBuyButton1, licenseBuyButton2, licenseText6);
    licenseStep4.append(licenseIcon4, licenseTitle4, licenseText7, licenseText8, licenseText9, licenseText10, activateFreeBtn);
    ...
    aboutVersion.innerHTML = 'Version 1.3.0 <br><br> What\'s New';
    ...
    const createPromotionBanner = () => {
        if (!hasLicense) {
            ...
            text3.append(document.createTextNode("Unlimited Search Results with detailed torrent info"));
            text4.innerHTML = "1-YR Subscription to CyberGhost VPN <span style='font-size:8px;'>(PRO+VPN only)</span>";
            ...
            chrome.storage.local.get({ 'b' : null }, function(data) {
                if (data.b == "bt") {
                    ...
                    licenseName.innerHTML = "µTorrent Web Pro.";
                }
            });
