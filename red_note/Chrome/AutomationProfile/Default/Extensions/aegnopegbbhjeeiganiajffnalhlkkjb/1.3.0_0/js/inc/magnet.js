var M = (function () {
     ...
     */
    var magnetURIDecode = function (uri) {
        const result = {};
        ...
        if (result.dn) result.info = { name: result.dn };
    ...
    var magnetURIEncode = function (obj) {
    ...
    var functions = {
        get_magnet_uri: function (magnet) {
            // Read magnet
            var m = null;

            m = magnetURIDecode(magnet);
