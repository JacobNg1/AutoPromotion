var T = (function () {
		...
		*/
		...
		Torrent.prototype = {
            ...
            off: function (event, callback) {
                if (event in this.events) {
                    var callbacks = this.events[event], i;
    ...
    var functions = {
        get_torrent_info: function (file, callback) {
            // Read files
            var t, err = {};
            ...
            t.on("load", function () {
                this.data.magnetUri = t.convert_to_magnet(null, false, true, null, false);
